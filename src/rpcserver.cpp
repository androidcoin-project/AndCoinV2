...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Andcoin server stopping";
}
...
/* Dark features */
   ...
   // { "getstakegen",            &getstakegen,            true,      false,     false },
   // { "setstakegen",            &setstakegen,            true,      false,     false },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use andcoind";
...
std::string HelpExampleCli(string methodname, string args){
    return "> andcoind " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35222/\n";
}
