...
If you want to build Andcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a andcoin-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the andcoin directory
BDB_PREFIX="${ANDCOIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Andcoin Core to use our own-built instance of BDB
cd $ANDCOIN_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip andcoind" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Andcoind with compile script
---------------------
...
Security
---------------------
To help make your andcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, andcoin should be built with a non-executable stack
